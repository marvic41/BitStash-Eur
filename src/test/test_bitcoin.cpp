...
////////////////////////////////////////////////////////////// bitstash
        ...
        globalState = std::unique_ptr<BitStashState>(new BitStashState(dev::u256(0), BitStashState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::bitstashTestNetwork)));
