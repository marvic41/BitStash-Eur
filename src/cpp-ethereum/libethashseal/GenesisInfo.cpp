...
#include "genesis/bitstashMainNetwork.cpp"
#include "genesis/bitstashTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::bitstashMainNetwork: return c_genesisInfoBitStashMainNetwork;
	case Network::bitstashTestNetwork: return c_genesisInfoBitStashTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::bitstashMainNetwork: return c_genesisStateRootBitStashMainNetwork;
	case Network::bitstashTestNetwork: return c_genesisStateRootBitStashTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
