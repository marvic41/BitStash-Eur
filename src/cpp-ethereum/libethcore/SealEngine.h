...
////////////////////////////////////////////////////////////// // bitstash
	void setBitStashSchedule(EVMSchedule _bitstashSchedule) const { bitstashSchedule = _bitstashSchedule; }

	EVMSchedule& getBitStashSchedule() const { return bitstashSchedule; }
...
private:
	...
	mutable EVMSchedule bitstashSchedule; // bitstash
