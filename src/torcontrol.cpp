...
static const std::string TOR_SAFE_SERVSATSHEY = "Tor safe cookie authentication server-to-controller hash";
...
void TorController::authchallenge_cb(TorControlConnection& _conn, const TorControlReply& reply)
{
    if (reply.code == 250) {
        ...
        if (l.first == "AUTHCHALLENGE") {
            ...
            std::vector<uint8_t> computedServerHash = ComputeResponse(TOR_SAFE_SERVSATSHEY, cookie, clientNonce, serverNonce);
