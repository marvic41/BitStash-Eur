...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitstash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitstash-tx [options] <hex-tx> [commands]  Update hex-encoded bitstash transaction\n" +
            "or:     bitstash-tx [options] -create [commands]   Create hex-encoded bitstash transaction\n" +
            "\n";
