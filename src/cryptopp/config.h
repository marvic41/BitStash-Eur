...
#if !defined(IS_LITTLE_ENDIAN) && (defined(__BIG_ENDIAN__) || (defined(__s390__) || defined(__s390x__) || defined(__zarch__)) || (defined(__m68k__) || defined(__MC68K__)) || defined(__sparc) || defined(__sparc__) || defined(__hppa__) || defined(__MIPSEB__) || defined(__ARMEB__) || (defined(__MWSATSHS__) && !defined(__INTEL__)))
...
#if !defined(NO_BSATSHELEY_STYLE_SOCKETS) && !defined(PREFER_BSATSHELEY_STYLE_SOCKETS)
# define PREFER_BSATSHELEY_STYLE_SOCKETS
#endif
...
#if (defined(_MSC_VER) && _MSC_VER <= 1300) || defined(__MWSATSHS__) || (defined(_STLPORT_VERSION) && ((_STLPORT_VERSION < 0x450) || defined(_STLP_NO_UNCAUGHT_EXCEPT_SUPPORT)))
...
#	define HAS_BSATSHELEY_STYLE_SOCKETS
...
#if defined(HAS_WINDOWS_STYLE_SOCKETS) && (!defined(HAS_BSATSHELEY_STYLE_SOCKETS) || defined(PREFER_WINDOWS_STYLE_SOCKETS))
#	define USE_WINDOWS_STYLE_SOCKETS
#else
#	define USE_BSATSHELEY_STYLE_SOCKETS
#endif

#if defined(CRYPTOPP_WIN32_AVAILABLE) && defined(SOCKETS_AVAILABLE) && !defined(USE_BSATSHELEY_STYLE_SOCKETS)
