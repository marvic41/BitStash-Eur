...
private:
    ...
    void StakeBitStashs(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking bitstashs */
    void StartStake(CConnman* connman) { StakeBitStashs(true, connman); }

    /* Stop staking bitstashs */
    void StopStake() { StakeBitStashs(false, 0); }
