...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SATSH");
    case mBTC: return QString("mSATSH");
    case uBTC: return QString::fromUtf8("µSATSH (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uBTC: return QString::fromUtf8("µSATSH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BitStashs");
    case mBTC: return QString("mSATSH (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("µSATSH (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
