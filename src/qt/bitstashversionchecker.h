#ifndef SATSHVERSIONCHECKER_H
#define SATSHVERSIONCHECKER_H

#include <QObject>

#define SATSH_RELEASES "https://github.com/bitstash/bitstash/releases"
...
class BitStashVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BitStashVersionChecker(QObject *parent = 0);
    ~BitStashVersionChecker();
