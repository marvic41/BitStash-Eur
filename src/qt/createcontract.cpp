...
void CreateContract::setLinkLabels()
{
    ...
    ui->labelSolidity->setText("<a href=\"https://qmix.bitstash.org/\">Solidity compiler</a>");
...
void CreateContract::on_gasInfoChanged(quint64 blockGasLimit, quint64 minGasPrice, quint64 nGasPrice)
{
    ...
    ui->labelGasPrice->setToolTip(tr("Gas price: SATSH price per gas unit. Default = %1, Min = %2").arg(QString::fromStdString(FormatMoney(DEFAULT_GAS_PRICE))).arg(QString::fromStdString(FormatMoney(minGasPrice))));
