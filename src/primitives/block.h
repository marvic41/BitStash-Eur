...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // bitstash
        hashUTXORoot.SetNull(); // bitstash
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //bitstash
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //bitstash
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //bitstash
    {
