...
"""
class BitStashPOSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Allow the bitstash staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    BitStashPOSConflictingStakingMempoolTxTest().main()