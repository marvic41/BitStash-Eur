...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see bitstash-dgp.py
"""
class BitStashDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the bitstashd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    BitStashDGPActivation().main()
